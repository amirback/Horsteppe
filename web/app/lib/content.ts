...
export const content: Record<Lang, Dict> = {
  ...
  kk: {
    nav: { home: "Басты бет", product: "Өнім", team: "Команда", pricing: "Тарифтер", blog: "Журнал", search: "Іздеу" },
    hero: {
      title: "Дала оркестрі.",
      sub1: "Жасанды интеллектті бейне-шедевріңізді",
      sub2: "жасауға жұмылдыратын конвейер.",
      cta: "Толығырақ",
    },
    problem: {
      kicker: "Мәселе",
      title: "Бүгін дайын ролик — бұл жеті қосымша бет және үш сағат",
      beforeTitle: "Қазір мұны қалай істейді",
      beforeItems: [
        "Сценарий жазуға — LLM",
        "Кадрларға — сурет генераторы",
        "Қозғалысқа — Runway / Kling / Veo",
        "Дыбыстауға — ElevenLabs",
        "Құқығы таза музыка іздеу",
        "Монтажға — CapCut немесе Premiere",
        "Субтитрлерге — бөлек сервис",
        "Соңында мұның бәрін біріктіріп, экспорттау керек",
      ],
      beforeFooter:
        "Әр қадамның өз аккаунты, өз файл пішімі және өз ақысы бар. Оның үстіне монтаж жасай білу керек.",
      afterTitle: "Бізде бұл қалай жұмыс істейді",
      afterItems: ["Бір енгізу өрісі", "Бір түйме", "Дауысы, субтитрі және музыкасы бар дайын MP4"],
      afterFooter: "Біз тағы бір генерация моделін сатпаймыз. Біз процестің өзін алып тастаймыз.",
    },
    how: {
      kicker: "Қалай жұмыс істейді",
      title: "Жүйе өзі өтетін алты қадам",
      sub: "Шағын продакшн-команда өтетін дәл сол жол — тек автоматты түрде.",
      steps: [
        { n: "01", title: "Тапсырманы түсінеді", text: "Сөйлеміңізді талдайды: пішім, ұзақтық, көңіл-күй, алаң және сізге шын мәнінде қандай нәтиже керек екенін." },
        { n: "02", title: "Тарихты жазады", text: "Күшті бастамасы, дамуы, шарықтау шегі және айқын финалы бар сценарий құрады — әдемі кадрлар жиынтығын емес." },
        { n: "03", title: "Дауыстайды", text: "Алдымен дауысты синтездейді: әр сценаның ұзақтығын сұралған секунд емес, нақты дыбыстау белгілейді." },
        { n: "04", title: "Сценаларды жоспарлап, түсіреді", text: "Тарихты кадрларға бөліп, оларды жасайды және бүкіл роликтің бірыңғай стилін сақтайды." },
        { n: "05", title: "Қозғалыс қосады", text: "Әр кадрды камераның басқарылатын қозғалысымен жандандырады, ал қымбат генерацияға тек қозғалыс шынымен жұмыс істейтін жерде ақша жұмсайды." },
        { n: "06", title: "Монтаждап, береді", text: "Таймлайн жинайды, субтитр мен музыка қосады, дыбысты біріктіріп, дайын MP4 шығарады." },
      ],
    },
    budget: {
      kicker: "Негізгі идея",
      title: "Әр секунд бірдей тұрмайды",
      sub: "Қымбат AI-бейнегенерация тек қозғалыс кадрға шынымен жұмыс істейтін жерде ақталады. Қалғаны жасалған суреттің үстінен камераның басқарылатын қозғалысымен түсіріледі. Көрермен айырмашылықты байқамайды — ал роликтің өзіндік құны бірнеше есе төмендейді.",
      exampleLabel: "60 секундтық ролик үшін бөлу мысалы",
      premium: "Премиум AI-бейне",
      motion: "Кадр бойынша қозғалыс",
      scenes: [
        { n: 1, kind: "motion", label: "Бастама" },
        { n: 2, kind: "motion", label: "Даму" },
        { n: 3, kind: "premium", label: "Негізгі сәт" },
        { n: 4, kind: "motion", label: "Өтпелі" },
        { n: 5, kind: "premium", label: "Шарықтау" },
      ],
      barNaiveLabel: "60 секундтың бәрін қымбат модельмен жасау",
      barSmartLabel: "Horsteppe: премиум тек көрінетін жерде",
      footnote:
        "Суреттегі схема — жоспарлаушының логикасы, нақты роликтің кепілдендірілген нәтижесі емес. Нақты бөлуді жүйе әр тарих үшін бөлек есептейді.",
    },
    features: {
      kicker: "Ішінде не бар",
      title: "Бір модельдің үстіндегі қабық емес, продакшн-конвейер",
      items: [
        { title: "AI-режиссёр", text: "Драматургияға жауап береді: ілмек, даму, шарықтау және финал. Онсыз ролик кездейсоқ кадрларға ыдырайды." },
        { title: "Сцена жоспарлаушы", text: "Таймингті және мәтін тығыздығын есептейді, сондықтан бір минуттық ролик он бес секундта дауыстап бітпейді." },
        { title: "Ақылды визуал бюджеті", text: "Қымбат бейнегенерация қажет жерді және камера қозғалысы жеткілікті жерді шешеді — өзіндік құнды бақылауда ұстайды." },
        { title: "Ассеттерді қайта пайдалану", text: "Бір локация немесе объект сценалар арасында қайта қолданылады: шығын аз, байланыс көп." },
        { title: "Дауыс — метроном", text: "Монтаж тайминг сұралған секундқа емес, дыбыстаудың нақты ұзақтығына құрылады." },
        { title: "Автоматты монтаж", text: "Таймлайн, өтпелер, субтитр, дыбысты біріктіру және соңғы экспорт — редакторда қолмен жұмыссыз." },
        { title: "Провайдерлерден тәуелсіздік", text: "Модельдер ауыстырылатын модуль ретінде қосылған. Бір сервис құласа немесе қымбаттаса, конвейер жұмысын жалғастырады." },
        { title: "Ролик соңына дейін жетеді", text: "Премиум генерация қолжетімсіз болса, сцена жергілікті жиналады. Бір ақаулы сервис бүкіл жобаны алып кетпеуі керек." },
      ],
    },
    roadmap: {
      kicker: "Жағдай туралы шындық",
      title: "Бүгін не бар және әрі қарай не болады",
      sub: "Біз ерте қолжетімділік сатысындамыз. Белгішелер тізімін емес, нақты жағдайды көрсетеміз.",
      columns: [
        {
          title: "Конвейер ядросы", state: "Жабық тестте",
          items: ["Идея → сценарий → сценалар", "Кадр генерациясы", "Дауыс және сцена бойынша тайминг", "Кадр бойынша камера қозғалысы", "Жинау және MP4 экспорты", "Әр ақылы шақырудың құны жазылады", "Ақаудан кейін жалғастыру"],
        },
        {
          title: "Жақын апталар", state: "Жұмыста",
          items: ["Бейнеге енгізілген субтитрлер", "Сценалар арасындағы өтпелер", "Негізгі сценаларға премиум AI-бейне", "Генерацияның тірі күйі", "Жобалар тарихы"],
        },
        {
          title: "Одан кейін", state: "Жоспарда",
          items: ["Көлденең 16:9 және автокадрлау", "Сценалар арасында бірыңғай кейіпкер", "Бір сценаны толық қайта жинамай өңдеу", "Shorts пен Reels үшін анимациялық субтитрлер", "Роликті басқа тілдерге локализациялау"],
        },
      ],
    },
    demo: {
      kicker: "Демо",
      title: "Жүйе басынан аяғына дейін жинаған ролик",
      sub: "Кіріске бір сөйлем. Сценарий, кадрлар, дауыс және монтаж — адамның қатысуынсыз.",
      placeholder: "Демо-ролик дайындалып жатыр",
      caption: "Мұнда флагмандық мысал пайда болады. Ол дайындалып жатқанда соңғы нұсқасын жеке көрсете аламыз.",
    },
    team: {
      kicker: "Команда",
      title: "Әдейі шағын",
      sub: "Үш рөл, айқын шекара. Ешкім бәрін бірден істемейді.",
      roles: [
        { role: "Негізін қалаушы және өнім", who: "Әмірхан", text: "Өнім көзқарасы, басымдықтар, клиенттермен сұхбат, сату және демо. Және ең қиын жұмыс — нені жасамау керегін шешу." },
        { role: "Өнім инженері", who: "", text: "Фронтенд, веб-интеграция, деплой және дерекқор. Конвейерді адам қолдана алатын нәрсеге айналдырады." },
        { role: "AI әзірлеу агенті", who: "", text: "Репозиторийді оқиды, нүктелі тапсырмаларды орындайды, тесттерді жүргізеді және интеграцияларды жөндейді. Провайдерде ақша жұмсауды немесе архитектураны қайта жазуды ешқашан өзі шешпейді." },
      ],
      note: "Startup Orda 2 қатысушысы.",
    },
    pricing: {
      kicker: "Тарифтер",
      title: "Бағасы әлі жоқ — және бұл саналы шешім",
      sub: "Алдымен дайын ролик шын мәнінде қанша тұратынын өлшейміз, сосын ғана сатамыз. Әзірге тапсырмаларды қолмен аламыз және жоба бойынша есептейміз. Төменде — тексеріп жатқан құрылым.",
      tiers: [
        { name: "Ерте қолжетімділік", price: "Келісім бойынша", note: "Қазір қолжетімді", items: ["Тапсырмаңызды жеке аламыз", "Дайын роликті аласыз", "Бірдеңе сынса — қолмен көмектесеміз", "Оның орнына — адал кері байланыс"], highlight: true },
        { name: "Creator", price: "Тексеруде", note: "Жоспарда", items: ["Жеңіл режимде шексіз ролик", "Айлық премиум-секунд пакеті", "Жобалар тарихы", "Тік және көлденең пішімдер"] },
        { name: "Agency", price: "Тексеруде", note: "Жоспарда", items: ["Өз провайдер кілтіңіз", "Топтық генерация", "Бренд-кит және пресеттер", "Басқа тілдерге локализация"] },
      ],
      footnote:
        "Неге бағасы әлі жоқ: роликтің өзіндік құны негізінен премиум-секундтармен анықталады, ал бұл сан бірнеше ондаған нақты жүрістен кейін ғана белгілі болады. Өлшемей баға жариялау — ұсыныс емес, болжам.",
    },
    blog: {
      kicker: "Журнал",
      title: "Шын мәнінде не болып жатыр",
      sub: "Тек шынымен өзгергені, күнімен. Әлі жоқ нәрсенің анонсынсыз.",
      posts: [
        { date: "2026 ж. 6 қыркүйек", title: "Жоспарды өзгерткен қозғалтқыш аудиті", text: "Ескі қозғалтқыштың архивін ашып, өлшедік: 162 файл, барлығы 46 КБ код және FFmpeg-ті іске қосатын бірде-бір шақыру жоқ — яғни ол бейнефайл ешқашан жасамаған. Жұмыс істейтін конвейер басқа, жаңарақ кодтық база болып шықты. Жоспар сол күні соның айналасында қайта жазылды." },
        { date: "2026 ж. 6 қыркүйек", title: "Master Bible 2.0", text: "Дайындық пайыздары гейттермен ауыстырылды: гейт не дәлелмен өтті, не өтпеді. Мүлдем болмаған бөлімдер пайда болды — провайдер лицензиялары, нәтижеге құқық және ақшаның қалай келіп-кететіні." },
        { date: "2026 ж. 5 қыркүйек", title: "Осы сайт іске қосылды", text: "Жобаның алғашқы жария артефактісі. Бір сессияда жиналып, жарияланды." },
      ],
    },
    faq: {
      kicker: "Сұрақтар",
      title: "Ең бастысы — қысқаша",
      items: [
        { q: "Генерация қанша уақыт алады?", a: "Әдетте бірнеше минут: жүйе сценарий жазады, кадрлар мен дауысты жасайды, содан кейін монтажды жинайды. Бұл лезде емес — бірақ бұл бірнеше сағаттық қол еңбегінің орнына жалғыз күту." },
        { q: "Монтаж жасай білу керек пе?", a: "Жоқ. Редактор да, кодек те, терминал командалары да керек емес. Сіз бейнені сөзбен сипаттайсыз да, дайын файл аласыз." },
        { q: "Бұл Runway немесе Sora-дан несімен өзгеше?", a: "Ондай сервистер бірнеше секундтық жеке клип береді. Horsteppe бүкіл ролик үшін жауап береді: тарих, сценалар реті, дауыс, субтитр және монтаж — және бұл үшін қандай модельдерді қолдануды өзі шешеді." },
        { q: "Ролик қандай тілдерде сөйлей алады?", a: "Ерте қолжетімділікте бұл — орыс және ағылшын тілдері. Басқа тілдерді сұраныс бойынша қосамыз: дауыс пен субтитр оларды техникалық қолдайды, бірақ нақты роликтерде тексермейінше тілді дайын деп жарияламаймыз." },
        { q: "Нәтиже кімге тиесілі?", a: "Ролик — сіздікі. Бұл ретте генерация өз шарттары бар сыртқы модельдерге сүйенеді, сондықтан коммерциялық тапсырмалар үшін мұны ерте қолжетімділік кезеңінде бөлек талқылаймыз." },
        { q: "Қазір төлеп, қолдануға бола ма?", a: "Біз қолжетімділікті бір-бірлеп ашамыз және алғашқы пайдаланушылармен қолмен жұмыс істейміз: тапсырманы аламыз, жасаймыз, нәтижені көрсетеміз және не шықты, не шықпағанын адал жазып отырамыз." },
      ],
    },
    cta: {
    ...
    footer: {
      ...
      contact: "Байланыс",
      orda: "Startup Orda 2 қатысушысы",
      lang: "Тіл",
    },
    waitlist: {
      subject: "Horsteppe — ерте қолжетімділік",
      body: "Сәлеметсіз бе!\n\nHorsteppe-ті қолданып көргім келеді.\n\nМаған қандай ролик керек: \nҰзақтығы: \nАлаң (YouTube / Instagram / TikTok / басқа): \nТілі: \n\nРақмет!",
    },
    searchUi: { placeholder: "Бет бойынша іздеу…", empty: "Ештеңе табылмады", close: "Жабу" },
  },
};
