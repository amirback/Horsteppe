...
export const studio: Record<Lang, StudioDict> = {
  en: {
    ...
    errors: {
      ...
      rate_limit_global: "The service is at its daily capacity. Please try again tomorrow.",
      retry_limit: "This project has used all its retries. Create a new one instead.",
      signup_throttled: "Too many sign-ups from your network. Try again in an hour.",
      password_too_long: "The password is too long — at most 72 characters.",
  ...
  ru: {
    ...
    errors: {
      ...
      rate_limit_global: "Сервис исчерпал дневную мощность. Попробуйте завтра.",
      retry_limit: "Попытки для этого проекта закончились. Создайте новый.",
      signup_throttled: "Слишком много регистраций из вашей сети. Попробуйте через час.",
      password_too_long: "Пароль слишком длинный — не больше 72 символов.",
  ...
  kk: {
    ...
    errors: {
      ...
      rate_limit_global: "Қызметтің тәуліктік қуаты таусылды. Ертең қайталаңыз.",
      retry_limit: "Бұл жобаның әрекеттері таусылды. Жаңасын жасаңыз.",
      signup_throttled: "Желіңізден тіркелу тым көп. Бір сағаттан кейін қайталаңыз.",
      password_too_long: "Құпиясөз тым ұзын — ең көбі 72 таңба.",
      ...
      weak_password: "Құпиясөз тым қысқа — кемінде 8 таңба.",
